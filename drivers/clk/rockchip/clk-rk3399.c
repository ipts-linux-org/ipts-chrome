...
PNAME(mux_pll_src_vpll_dmycpll_dmygpll_p)	= { "vpll", "dummy_cpll", "dummy_gpll" };
...
static struct rockchip_clk_branch rk3399_clk_branches[] __initdata = {
	...
	COMPOSITE(DCLK_VOP0_DIV, "dclk_vop0_div", mux_pll_src_vpll_dmycpll_dmygpll_p, CLK_SET_RATE_PARENT,
	...
	COMPOSITE(SCLK_VOP1_PWM, "clk_vop1_pwm", mux_pll_src_dmyvpll_cpll_gpll_24m_p, CLK_IGNORE_UNUSED,
